<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&duration=3000&pause=1000&color=3B82F6&center=true&vCenter=true&width=600&lines=Hi+%F0%9F%91%8B+I'm+Andria+Janelidze;Frontend+Developer+%7C+React+Specialist;2%2B+Years+of+Experience;Building+Exceptional+Web+Experiences" alt="Typing SVG" />
</div>
...
Frontend Developer with **2+ years** of hands-on experience specializing in React.js, JavaScript, TypeScript, and modern web technologies. I'm passionate about creating scalable, high-performance web applications that deliver exceptional user experiences.
...
const andria = {
  ...
  funFact: "I reduced page load time by 60% in my latest project! ⚡"
};
```

### 🎯 Key Achievements

- 📈 **Increased user engagement by 45%** through interactive UI enhancements
- ⚡ **Reduced page load time by 60%**, significantly improving responsiveness
- 🎨 **Boosted client retention by 35%** with strategic UI redesigns
- 🌐 **Expanded user base by 25%** via enhanced cross-browser compatibility
- 🔧 **Cut debugging time by 40%** through automated testing processes
...
- 🎨 Developed responsive web applications using **React.js**, **TypeScript**, and **Next.js**
- 🏗️ Built user-friendly UI components with **Tailwind CSS** and **Material-UI**
